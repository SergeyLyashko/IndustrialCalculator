...
###### ![режим по умолчанию](https://github.com/SergeyLyashko/PromCalculator/blob/master/screenshots/default_dark.jpg)
###### И не акивные элементы:
###### строка вывода результата расчета и строка вывода служебной информации
###### ![рабочий режим](https://github.com/SergeyLyashko/PromCalculator/blob/master/screenshots/work_1.jpg)
...
###### ![настройки](https://github.com/SergeyLyashko/PromCalculator/blob/master/screenshots/settings.jpg)
...
###### ![справка](https://github.com/SergeyLyashko/PromCalculator/blob/master/screenshots/info_dark.jpg)
